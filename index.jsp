...
<center>
	...
	String logdir = System.getenv("OPENSHIFT_MONGODB_DB_HOST"); 
	
 	out.println("Using custom log directory as : "+ logdir);

	out.println(System.getProperty("testing1"));
        out.println(System.getProperty("testing2"));
